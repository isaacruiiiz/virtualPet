public class virtualPet {
    public static void main(String[] args) {
        ...
        sleep = (int) (Math.random() * (MAX - MIN + 1) + MIN);
        fatigue = (int) (Math.random() * (MAX - MIN + 1) + MIN);
        energy = (int) (Math.random() * (MAX - MIN + 1) + MIN);
        hygiene = (int) (Math.random() * (MAX - MIN + 1) + MIN);
        weight = (int) (Math.random() * (MAX - MIN + 1) + MIN);
        ...
        if (firstChoice.equalsIgnoreCase("dog")) {
            ...
            while ((sleep <= 100 || sleep > 0 || fatigue <= 100 || fatigue > 0 || energy <= 100 || energy > 0 || hygiene <= 100 || hygiene > 0 || weight <= 100 || weight > 0)&&(death == false));
            System.out.println(" ");
